  ...
  return (
    <div className="bg-white rounded-[2rem] overflow-hidden flex flex-col border border-stone-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group w-105">
      ...
      <div className="p-6 pt-4 flex flex-col flex-1">
        ...
        {/* Windows */}
        {/* Comments include Lunch and Dinner windows with their respective statuses, but they are currently commented out. */}
        ...
        {/* <nav className="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-stone-200 h-20 px-6 md:px-12 flex justify-between items-center shadow-sm">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <div className="hidden sm:flex items-center bg-stone-100 rounded-full px-4 py-2 border border-stone-200">
              <span className="material-symbols-outlined text-stone-400 mr-2 text-xl">
                search
              </span>
              <input
